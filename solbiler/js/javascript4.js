...
sentinfo.innerHTML = "Tjek om du har indsendt de rigtige oplysninger om dig selv her: " + "<br>Navn: " + sessionStorage.getItem("fornavn") + " " + sessionStorage.getItem("efternavn") + 
